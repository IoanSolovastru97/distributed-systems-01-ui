...
import { DoctorMedicalrecordCreateRoutingModule } from './doctor-medicalrecord-create-routing.module';
import { DoctorMedicalrecordCreateComponent } from './doctor-medicalrecord-create/doctor-medicalrecord-create.component';

@NgModule({
  declarations: [DoctorMedicalrecordCreateComponent],
  imports: [CommonModule, FormsModule, DoctorMedicalrecordCreateRoutingModule, SharedComponentsModule],
  providers: [
    ApiService,
    AuthGuard,
    AuthService,
...
export class DoctorMedicalrecordCreateModule { }
