...
import { DoctorCaregiverEditRoutingModule } from './doctor-caregiver-edit-routing.module';

@NgModule({
    declarations: [DoctorCaregiverEdit],
    imports: [CommonModule, FormsModule, DoctorCaregiverEditRoutingModule, SharedComponentsModule],
    providers: [
        ApiService,
        AuthGuard,
        AuthService,
...
export class DoctorCaregiverEditModule { }
