...
import { DoctorCaregiverRoutingModule } from './doctor-caregiver-routing.module';
import { DoctorCaregiverComponent } from './doctor-caregiver/doctor-caregiver.component';

@NgModule({
  declarations: [DoctorCaregiverComponent],
  imports: [CommonModule, FormsModule, DoctorCaregiverRoutingModule, SharedComponentsModule],
  providers: [
    ApiService,
    AuthGuard,
    AuthService,
...
export class DoctorCaregiverModule { }
