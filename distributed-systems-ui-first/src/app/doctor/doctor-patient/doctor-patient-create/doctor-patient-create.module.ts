...
import { DoctorPatientCreateRoutingModule } from './doctor-patient-create-routing.module';
import { DoctorPatientCreateComponent } from './doctor-patient-create/doctor-patient-create.component';

@NgModule({
  declarations: [DoctorPatientCreateComponent],
  imports: [CommonModule, FormsModule, DoctorPatientCreateRoutingModule, SharedComponentsModule],
  providers: [
    ApiService,
    AuthGuard,
    AuthService,
...
export class DoctorPatientCreateModule { }
