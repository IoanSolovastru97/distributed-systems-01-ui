...
import { DoctorPatientRoutingModule } from './doctor-patient-routing.module';
import { DoctorPatientComponent } from './doctor-patient/doctor-patient.component';

@NgModule({
  declarations: [DoctorPatientComponent],
  imports: [CommonModule, FormsModule, DoctorPatientRoutingModule, SharedComponentsModule],
  providers: [
    ApiService,
    AuthGuard,
    AuthService,
